    ...
    <body>
        <div class="container">
            ...
            <div>
                ...
                <a class="btn btn-primary mb-3" href="/Tienda_1?accion=agregarcliente">Agregar Cliente</a><br><br>
            </div>
                    ...
                    <c:forEach items="${listaClientes}" var="item">
                        <tr>
                            ...
                            <td class="text-center">
                                <form method="POST" action="/Tienda_1/crud/modificar/modificarcliente.jsp">
                                ...
                                <form method="POST" action="/Tienda_1/crud/eliminar/eliminarcliente.jsp">
                                    <input type="hidden" name="id_Cliente" value="${item.ID_Cliente}" />
                                    <input type="hidden" name="nombresCliente" value="${item.NombresCliente}" />             
